...
class Preprocessor:
    ...
    def remove_columns(self, data, columns):
        ...
        try:
            ...
            self.logger_object.log(self.file_object, 'Column removal Successful.Exited the remove_columns method of '
            ...
            self.logger_object.log(self.file_object, 'Column removal Unsuccessful. Exited the remove_columns method '
