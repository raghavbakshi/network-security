...
class KMeansClustering:
    ...
    def elbow_plot(self, data):
        ...
        try:
            ...
            plt.ylabel('WCSS')
            # plt.show()
            plt.savefig('data_peprocessing/K-Means_Elbow.PNG')  # saving the elbow plot locally
            ...
            self.logger_object.log(self.file_object,
                                   'Exception occured in elbow_plot method of the KMeansClustering class. Exception '
                                   'message:  ' + str(
                                       e))
            self.logger_object.log(self.file_object,
