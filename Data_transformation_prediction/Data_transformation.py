...
class Transformation:
    ...
    def __init__(self):
        self.goodDataPath = "Prediction_rawfiles_validated/Good_Raw"
        self.logger = logger()

    def missing_value_and_serial(self):
        """
                      Method Name: missing_value_and_serial
                      Description: This method fills the columns with missing values and add serial for database.
        ...
        f = open("Prediction_Logs/Missing_values_logs.txt", 'a+')
